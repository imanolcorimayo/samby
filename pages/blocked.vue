<template>
  <div class="min-h-screen flex items-center justify-center bg-gray-100 m-auto">
    <div class="text-center p-6 max-w-lg mx-auto bg-white rounded-lg shadow-lg">
      ...
      <p class="text-lg text-gray-600 mb-6">Parece que no tenes permisos para acceder a esta pagina.</p>
      <p class="text-lg text-gray-600 mb-6">Si crees que esto es un error contactate con Samby!</p>
