      ...
      <div class="container mx-auto px-4 py-4">
        <div class="flex justify-between items-center">
          ...
          <nav class="hidden md:flex items-center space-x-8">
            <NuxtLink to="/features" class="text-gray-600 hover:text-primary">Funcionalidades</NuxtLink>
            ...
            <NuxtLink to="/contact" class="text-gray-600 hover:text-primary">Contacto</NuxtLink>
          </nav>

          <!-- Auth Buttons -->
          <div class="flex items-center gap-4">
            <NuxtLink to="/welcome" class="hidden md:inline-block text-gray-600 hover:text-primary"
              >Iniciar sesión</NuxtLink
            >
            <NuxtLink to="/welcome" class="btn bg-primary text-white px-4 py-2 rounded-lg">Prueba gratis</NuxtLink>

            <!-- Mobile Menu Button -->
            <button @click="mobileMenuOpen = !mobileMenuOpen" class="md:hidden text-gray-500 focus:outline-none">
              <svg
        ...
        <div v-if="mobileMenuOpen" class="md:hidden mt-4 pb-4">
          <NuxtLink to="/features" class="block py-2 text-gray-600 hover:text-primary">Funcionalidades</NuxtLink>
          ...
          <NuxtLink to="/contact" class="block py-2 text-gray-600 hover:text-primary">Contacto</NuxtLink>
      ...
      <div class="container mx-auto px-4">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul class="space-y-2">
              <li><NuxtLink to="/features" class="text-gray-300 hover:text-white">Funcionalidades</NuxtLink></li>
              <li><NuxtLink to="/features/inventory" class="text-gray-300 hover:text-white">Inventario</NuxtLink></li>
              <li><NuxtLink to="/features/orders" class="text-gray-300 hover:text-white">Pedidos</NuxtLink></li>
              <li><NuxtLink to="/features/analytics" class="text-gray-300 hover:text-white">Analíticas</NuxtLink></li>
          ...
          <div>
            ...
            <ul class="space-y-2">
              ...
              <li><NuxtLink to="/contact" class="text-gray-300 hover:text-white">Contacto</NuxtLink></li>
              <li><NuxtLink to="/blog" class="text-gray-300 hover:text-white">Blog</NuxtLink></li>
